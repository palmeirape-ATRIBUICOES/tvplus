...
class ReceitanetRobotService {
    ...
    async cadastrarEAtivarTV(cliente, loginTvInput, senhaTvInput) {
        ...
        console.log(`[STARTV-ROBOT] 🚀 Criando usuário '${loginTv}' do zero com CPF/Senha '${cpf}'...`);

        try {
            // ETAPA 1: Acessar a página https://sistema.receitanet.net/clientes_cadastro.php
            console.log(`[STARTV-ROBOT] ETAPA 1: Acessando https://sistema.receitanet.net/clientes_cadastro.php...`);
            ...
            console.log(`[STARTV-ROBOT] Preenchendo Login: '${loginTv}', Senha (CPF): '${senhaTv}', Nome: '${nomeCliente}', CPF: '${cpf}'...`);
            ...
            console.log(`[STARTV-ROBOT] Clicando no botão Incluir do cadastro...`);
            await Promise.all([
                page.evaluate(() => {
            ...
            console.log(`[STARTV-ROBOT SUCCESS] 🎉 CRIAÇÃO DO CLIENTE E INCLUSÃO DO PLANO CDNTV FINALIZADA COM SUCESSO!`);
            return true;
        } catch (error) {
